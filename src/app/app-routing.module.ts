...
const routes: Routes = [
  ...
  { path: 'news/create', component: NewsCreateComponent, canActivate: [AuthAdminGuard] },
  ...
  { path: 'league/:id', component: LeagueViewComponent,
    children: 
    [
  ...
  { path: 'team/:id/edit', component: TeamEditComponent, canActivate:[AuthGuard] },
  ...
  { path: 'users/list', component: UsersListComponent, canActivate: [AuthAdminGuard]},
  { path: 'teams/create', component: TeamCreateComponent, canActivate: [AuthGuard] },
  { path: 'teams/search', component: TeamSearchComponent, canActivate: [AuthGuard] },
