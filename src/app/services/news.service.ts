...
export class NewsService {
  ...
  checkCreateFormErrors(errors: any): void {
    ...
    if (errors.sendUserMinLength)
      this.setCreateErrors(errors.sendUserMinLength);
    if (errors.sendUserMaxLength)
      this.setCreateErrors(errors.sendUserMaxLength);
    ...
    if (errors.locationMinLength)
      this.setCreateErrors(errors.locationMinLength);
    if (errors.locationMaxLength)
      this.setCreateErrors(errors.locationMaxLength);
  }
