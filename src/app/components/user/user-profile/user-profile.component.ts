...
export class UserProfileComponent implements OnInit {
  ...
  uploadFile(): void {
    ...
    if (this.formModelAvatar.get('Avatar') != null) {
      this.userService.updateProfileImage(this.formModelAvatar.get('Avatar').value);
  ...
  onSubmit(): void {
    this.userService.setIsSaving(true);
    let body = {
      name: this.formModel.value.Name ? this.formModel.value.Name.trim() : null,
      surname: this.formModel.value.Surname ? this.formModel.value.Surname.trim() : null,
      birthdate: this.formModel.value.Birthdate,
      country: this.formModel.value.Country ? this.formModel.value.Country.trim() : null,
